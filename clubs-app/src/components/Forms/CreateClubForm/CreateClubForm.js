...
class CreateClubForm extends Component {
    ...
    addProgress(progress) {
        ...
        if (progress > 0 && this.state.formPart < 3){
        ...
        if (this.state.formPart > 3){
            this.setState({formPart: 3})
        }
    ...
    render() {
        ...
        let formPart1 = (
            <Form onSubmit={(event) => this.submit(event)} style={{display: this.state.formPart===1 ? "" : "none"}} className={classes.formGroup}>
                ...
                <Form.Text>
                    Your location is your main place of gathering, when people look at your group's progile this
            ...
            >
                ...
                <ModalFooter>
                    <div className={classes.buttonGroup}>
                        <button className={classes.leftButton} onClick={() => this.addProgress(-50)}>
                            {this.state.formPart === 1 ? "Cancel":"Previous"}
                        </button>
                        <button className={classes.rightButton} onClick={() => this.addProgress(50)}>
